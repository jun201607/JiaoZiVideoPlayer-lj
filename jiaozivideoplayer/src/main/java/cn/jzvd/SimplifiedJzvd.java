 ...
 * On 2018/10/08 9:15
 */
public class SimplifiedJzvd extends Jzvd {
    ...
    public SimplifiedJzvd(Context context) {
        super(context);
    }

    public SimplifiedJzvd(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public int getLayoutId() {
        return R.layout.jz_layout_fansi;
    }
